...
class Recognizer(AudioSource):
    ...
    def recognize_google_cloud_async(self, credentials_json=None, language="en-US", preferred_phrases=None, show_all=False, gs_uri=None):
        """
        ...
        #speech_config = {"languageCode": language, "audio_channel_count":2}
        speech_config = {"languageCode": language}

        #speech_config = {"encoding": "FLAC", "sampleRateHertz":
        #audio_data.sample_rate, "languageCode": language}
        ...
        if not gs_uri:
          ...
          print("LONG TASK")
          request = speech_service.speech().longrunningrecognize(body={"audio": {"uri": gs_uri}, "config": speech_config})
          print("Waiting for operation to complete...")
    ...
    def recognize_google_cloud(self, audio_data, credentials_json=None, language="en-US", preferred_phrases=None, show_all=False, gs_uri=None):
        """
        Performs speech recognition on ``audio_data`` (an ``AudioData`` instance), using the Google Cloud Speech API.
